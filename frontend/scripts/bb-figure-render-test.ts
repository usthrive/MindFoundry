...
const CASES: Array<[string, BBFigure]> = [
  ...
  // --- written mathematics -------------------------------------------------
  ['math-sentence · the take-away line (A16)', F('math-sentence', 'the line five minus two equals three written out large', { tokens: [{ text: '5' }, { text: '−' }, { text: '2' }, { text: '=' }, { text: '3', mark: 'underline' }] })],
  ['math-sentence · ring the step that goes first (D21)', F('math-sentence', 'three plus four times two, the times step ringed', { tokens: [{ text: '3' }, { text: '+' }, { text: '4', mark: 'ring' }, { text: '×', mark: 'ring' }, { text: '2', mark: 'ring' }, { text: '=' }, { text: '▢', mark: 'box' }] })],
  ['math-sentence · a phrase becomes its expression (E11)', F('math-sentence', 'the words three more than twice n, and under them the expression 2n plus 3', { tokens: [{ text: '3' }, { text: 'more' }, { text: 'than' }, { text: 'twice' }, { text: 'n', mark: 'underline' }], then: { connector: 'reads-as', tokens: [{ text: '2n' }, { text: '+' }, { text: '3' }] } })],
  ['column-method · the carry (D2/B13)', F('column-method', 'forty-seven plus twenty-six in columns, the carried one small above the tens', { op: '+', rows: [{ cells: ['1', ''], role: 'carry' }, { cells: ['4', '7'], role: 'operand' }, { cells: ['2', '6'], role: 'operand' }, { cells: ['7', '3'], role: 'result' }] })],
  ['column-method · borrow struck out (D2)', F('column-method', 'a subtraction with the tens digit struck and rewritten', { op: '−', rows: [{ cells: ['7', '13'], role: 'carry' }, { cells: ['8', '3'], role: 'operand', struck: [0, 1] }, { cells: ['2', '7'], role: 'operand' }, { cells: ['5', '6'], role: 'result' }] })],
  ['column-method · decimal alignment (D14)', F('column-method', 'two decimals stacked with the points in one line', { op: '+', pointAfterCol: 0, rows: [{ cells: ['2', '4', ''], role: 'operand' }, { cells: ['1', '3', '5'], role: 'operand' }, { cells: ['3', '7', '5'], role: 'result' }] })],
  // --- place value ---------------------------------------------------------
